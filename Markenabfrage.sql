...
--Update urban_NAV600.dbo.[Urban-Brand GmbH$Document Dimension] set [Dimension Value Code] = 'BUBBLE KID BERLIN' Where [Dimension Value Code] = 'BUBBLE. KID BERLIN' and [Dimension Code] = 'MARKE'  

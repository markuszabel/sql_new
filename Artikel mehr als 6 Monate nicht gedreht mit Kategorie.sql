...
it.[Attribute 2]
From [urban_NAV600].[dbo].[Urban-Brand GmbH$Item] as il with (NOLOCK)
Left Join [urban_NAV600].[dbo].[Urban-Brand GmbH$Item] as it (NOLOCK) on il.[No_] = it.No_
...
Where  best.Menge <> 0 and datediff(day,isnull(maxpostSales.MaxDate,maxpostPurch.MaxDate), GETDATE()) > 360
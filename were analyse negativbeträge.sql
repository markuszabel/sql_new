...
where ve.[Source No_] = '79187' and ve.[Location Code]='BER_FIEGE' and ve.[Posting Date] <= '2015-12-31' and ve.[Document Type] = 6
...
from urban_NAV600.dbo.[Urban-Brand GmbH$Value Entry] as ve
where ve.[Document Type] = 5 and ve.[Source No_] = '79187' and ve.[Location Code]='BER_FIEGE' and ve.[Posting Date] > '2015-12-31'
Group by
ve.[Posting Date],
